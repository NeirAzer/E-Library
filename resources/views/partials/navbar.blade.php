<nav class="bg-gray-800" x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/"
                            class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium {{ request()->is('/') ? 'text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <div class="relative ml-3">
                            ...
                            <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                                ...
                                class="absolute capitalize right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 ring-1 shadow-lg ring-black/5 focus:outline-hidden"
            ...
            @else
                <a href="/login"
                    class="text-sm font-semibold leading-6 bg-indigo-600 hover:bg-indigo-300 text-white px-3 py-2 rounded-md shadow-xs">Login</a>
            @endauth
        </div>
    </div>
    ...
    @auth
        ...
        <div x-show="isOpen" class="md:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <a href="/"
                    class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium {{ request()->is('/') ? 'text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                    aria-current="page">Homepage</a>
                <a href="/hall"
