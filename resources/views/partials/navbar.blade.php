<nav class="bg-gray-800" x-data="{ isOpen: false }">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium {{ request()->is('/') ? 'text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}" aria-current="page">Homepage</a>
                        <a href="/hall" class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('hall*') ? 'text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">Hall</a>
                        <a href="/about" class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('about*') ? 'text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">About</a>
                    </div>
                    </div>
                </div>
                <div class="hidden md:block">
            ...
            <div x-show="isOpen" class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                    <a href="/" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium {{ request()->is('/') ? 'text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}" aria-current="page">Homepage</a>
                    <a href="/hall" class="block rounded-md px-3 py-2 text-base font-medium {{ request()->is('hall*') ? 'text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">Hall</a>
                    <a href="/about" class="block rounded-md px-3 py-2 text-base font-medium {{ request()->is('about*') ? 'text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">About</a>
                </div>
