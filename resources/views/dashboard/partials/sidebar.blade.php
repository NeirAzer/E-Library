        ...
        <ul class="mt-4">
            ...
            <li class="my-3 group">
                <a href="/dashboard/book"
                    class="flex font-semibold items-center transition py-2 px-4 {{ request()->is('dashboard/book') ? 'bg-gray-950 text-white' : 'text-gray-900 bg-white ' }} rounded-md">
            ...
            <li class="my-3 group">
                <a href="/dashboard/borrow"
                    class="flex font-semibold items-center transition py-2 px-4 {{ request()->is('dashboard/borrow') ? 'bg-gray-950 text-white' : 'text-gray-900 bg-white ' }} rounded-md">
                    <i class="fa-solid fa-exchange-alt mr-3 text-lg"></i>
