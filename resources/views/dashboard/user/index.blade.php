...
@section('content')
  <div class="grid grid-cols-12 gap-4">
    <div class="col-span-12 lg:col-span-9 p-4">
      <a href="/dashboard/user/create" class="px-5 py-3 bg-blue-900 font-bold rounded-md text-white hover:bg-blue-800 transition">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4 flex gap-2">
                        <div class="text-orange-500 flex align-middle">
                            <a href="/dashboard/user/{{ $user->slug }}/edit" class="px-3 py-1 rounded-md hover:bg-orange-900 font-bold transition">
